...
public class Callback : PageModel
{
    ...
    private readonly SignInManager<MshrmStudioIdentityUser> _signInManager;
    ...
    private async Task<MshrmStudioIdentityUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new MshrmStudioIdentityUser("","",true)
        {
            Id = sub,
