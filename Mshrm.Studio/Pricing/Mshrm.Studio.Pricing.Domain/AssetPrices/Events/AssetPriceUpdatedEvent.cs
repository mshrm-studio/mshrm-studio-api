...
{
    public class AssetPriceUpdatedEvent : INotification
    {
        /// <summary>
        /// The asset price updated
        /// </summary>
        public int Id { get; private set; }

        /// <summary>
        /// The provider that updated the asset price
        /// </summary>
        ...
        public AssetPriceUpdatedEvent(int id, PricingProviderType pricingProviderType, decimal oldPrice, decimal newPrice, decimal? oldMarketCap,
