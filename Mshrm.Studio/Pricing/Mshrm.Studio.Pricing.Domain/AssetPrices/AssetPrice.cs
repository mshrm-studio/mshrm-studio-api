...
{ 
    [Index("GuidId")]
    public class AssetPrice : AuditableEntity, IAggregateRoot
    {
        ...
        public List<AssetPriceHistory> AssetPriceHistories { get; private set; }

        public AssetPrice(int baseAssetId, int assetId, decimal price, decimal? marketCap, decimal? volume, PricingProviderType pricingProviderType)
        {
            ...
            base.QueueDomainEvent(new AssetPriceCreatedEvent(this));
        }

        public void UpdateData(decimal newPrice, decimal? newMarketCap, decimal? newVolume, PricingProviderType pricingProviderType)
        {
            base.QueueDomainEvent(new AssetPriceUpdatedEvent(Id, pricingProviderType, Price, newPrice, MarketCap, newMarketCap, Volume, newVolume, DateTime.UtcNow));
        ...
        public void SetNewBaseAsset(Asset newBaseAsset, AssetPrice oldBasePrice, AssetPrice newBasePrice)
        {
