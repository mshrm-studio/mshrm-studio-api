...
namespace Mshrm.Studio.Pricing.Domain.Currencies
{
    public interface ICurrencyFactory
    {
        ...
        Currency CreateCurrency(PricingProviderType providerType, CurrencyType currencyType, string name, string symbol, string symbolNative, string? description, Guid? logoGuidId);
    }
}
