...
{
    public class MobulaCronJob : BackgroundService
    {
        private readonly IServiceScopeFactory _serviceScopeFactory;

        public MobulaCronJob(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        {
            var timeSpan = new TimeSpan(0,5,0);//5
            ...
            while (await timer.WaitForNextTickAsync(stoppingToken))
            {
                ...
                using (var serviceScope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    await jobService.ImportProviderAssetsAsync(PricingProviderType.Mobula);
                }
            }
        }
    }
