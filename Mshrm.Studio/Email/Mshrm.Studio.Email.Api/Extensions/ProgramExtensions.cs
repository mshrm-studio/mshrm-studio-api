...
using Mshrm.Studio.Email.Api.Repositories;
...
using Mshrm.Studio.Email.Application.Services;
using System.Data.SqlClient;
using Mshrm.Studio.Email.Domain.Emails;
using Mshrm.Studio.Email.Infrastructure.Factories;
using Mshrm.Studio.Shared.Enums;

namespace Mshrm.Studio.Email.Api.Extensions
{
    /// <summary>
    ...
    public static class ProgramExtensions
    {
        ...
        public static WebApplicationBuilder ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            // Setup the email services
            builder.Services.AddTransient<ISendEmailService, SendEmailService>();

            // Setup the repositories
            builder.Services.AddTransient<IEmailMessageRepository, EmailMessageRepository>();
        ...
        public static WebApplicationBuilder ConfigureMediatr(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<IRequestHandler<CreateEmailCommand, EmailMessage>, CreateEmailCommandHandler>();
        ...
        {
            builder.Services.AddAutoMapper(typeof(Mshrm.Studio.Email.Api.Mapping.MshrmStudioEmailMappingProfile).Assembly);
