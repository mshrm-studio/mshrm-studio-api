...
using Mshrm.Studio.Storage.Api.Models.Maps;

namespace Mshrm.Studio.Storage.Api.Contexts
{
    /// <summary>
    /// Domain context
    /// </summary>
    public class MshrmStudioStorageDbContext : DbContext
    {
        /// <summary>
        ...
        public MshrmStudioStorageDbContext(IMediator mediator, DbContextOptions<MshrmStudioStorageDbContext> options)
            : base(options)
        {
            _mediator = mediator;
        }
        ...
        {
            // Map entities
            _ = new ResourceMap(builder.Entity<Resource>());
