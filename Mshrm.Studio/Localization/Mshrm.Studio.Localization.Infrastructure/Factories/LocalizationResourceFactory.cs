...
namespace Mshrm.Studio.Localization.Infrastructure.Factories
{
    public class LocalizationResourceFactory : ILocalizationResourceFactory
    {
        /// <summary>
        ...
        {
            return new LocalizationResource(localizationArea, culture, name, value, comment);
        }
    }
}
