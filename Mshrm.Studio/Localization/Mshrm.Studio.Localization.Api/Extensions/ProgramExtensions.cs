...
using MediatR;
using Mshrm.Studio.Localization.Api.Repositories;
...
namespace Mshrm.Studio.Localization.Api.Extensions
{
    ...
    public static class ProgramExtensions
    {
        ...
        {
            builder.Services.AddTransient<ILocalizationResourceFactory, LocalizationResourceFactory>();
        ...
        public static WebApplicationBuilder ConfigureMediatr(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<IRequestHandler<GetLocalizationResourcesQuery, List<LocalizationResource>>, GetLocalizationResourcesQueryHandler>();
        ...
        {
            builder.Services.AddAutoMapper(typeof(Mshrm.Studio.Localization.Api.Mapping.MshrmStudioLocalizationMappingProfile).Assembly);
