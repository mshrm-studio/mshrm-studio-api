...
using Mshrm.Studio.Subscription.Api.Mapping;
...
namespace Mshrm.Studio.Subscription.Api.Extensions
{
    ...
    public static class ProgramExtensions
    {
        ...
        {
            builder.Services.AddTransient<ISubscriptionModelFactory, SubscriptionModelFactory>();
            builder.Services.AddTransient<IPricingStructureFactory, PricingStructureFactory>();

            builder.Services.AddTransient<ISubscriptionModelRepository, SubscriptionModelRepository>();
            builder.Services.AddTransient<IPricingStructureRepository, PricingStructureRepository>();
        ...
        {
            builder.Services.AddAutoMapper(typeof(MshrmStudioSubscriptionMappingProfile).Assembly);
