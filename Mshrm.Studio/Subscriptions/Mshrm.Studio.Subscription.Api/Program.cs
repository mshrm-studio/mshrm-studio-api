...
using Mshrm.Studio.Subscription.Api.Extensions;
...
builder.Services.AddSwaggerDocument(settings =>
{
    settings.PostProcess = document =>
    {
        ...
        document.Info.Title = "Mshrm.Studio Subscription API";
...
{
    await app.AddDatabaseMigrationAsync<MshrmStudioSubscriptionDbContext>();
}
